...
# TEQUILA_ENDPOINT = YOUR TEQUILA ENDPOINT HERE
# TEQUILA_API_KEY = TEQUILA API KEY HERE
    ...
    def check_flights(self, origin_airport, departure_airport_code, from_time, to_time):
        ...
        try:
            ...
            flight_data = FlightData(
                ...
                departure_city=data["route"][1]["cityTo"],
                departure_airport_code=data["route"][1]["flyTo"],
